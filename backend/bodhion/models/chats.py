...
from bodhion.internal.db import Base, JSONField, get_db, get_db_context
from bodhion.models.tags import TagModel, Tag, Tags
from bodhion.models.folders import Folders
from bodhion.models.chat_messages import ChatMessage, ChatMessages
from bodhion.utils.misc import sanitize_data_for_db, sanitize_text_for_db
    ...
    def update_chat_by_id(
        ...
        try:
            with get_db_context(db) as db:
                ...
                # Dual-write updated messages to chat_message table
                try:
                    ...
                    log.warning(
                        f"Failed to sync messages to chat_message table on update: {e}"
                    )
