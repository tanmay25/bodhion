...
from bodhion.models.knowledge import (
...
from bodhion.models.files import Files, FileModel, FileMetadataResponse
...
from bodhion.utils.auth import get_verified_user, get_admin_user
from bodhion.utils.access_control import has_permission, filter_allowed_access_grants
from bodhion.models.access_grants import AccessGrants


from bodhion.config import BYPASS_ADMIN_ACCESS_CONTROL
from bodhion.models.models import Models, ModelForm
            ...
            if len(updated_knowledge) != len(knowledge_list):
                ...
                model_form = ModelForm(
                    ...
                    access_grants=[
                        ...
                        for g in (model.access_grants or [])
                    ],
