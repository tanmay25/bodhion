...
from bodhion.routers.pipelines import process_pipeline_inlet_filter

from bodhion.utils.task import get_task_model_id
...
async def check_active_chats(
    ...
    from bodhion.tasks import get_active_chat_ids
