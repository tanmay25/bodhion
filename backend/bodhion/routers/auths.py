...
from bodhion.models.auths import (
    AddUserForm,
    ApiKey,
    Auths,
    Token,
...
from bodhion.models.users import (
    UserModel,
...
from bodhion.constants import ERROR_MESSAGES, WEBHOOK_MESSAGES
...
from bodhion.utils.misc import parse_duration, validate_email_format
...
from bodhion.utils.access_control import get_permissions, has_permission
from bodhion.utils.groups import apply_default_group_assignment

from bodhion.utils.redis import get_redis_client
from bodhion.utils.rate_limit import RateLimiter
...
async def get_admin_config(request: Request, user=Depends(get_admin_user)):
    return {
        ...
        "SHOW_ADMIN_EVALUATIONS": request.app.state.config.SHOW_ADMIN_EVALUATIONS,
        "SHOW_ADMIN_INTEGRATIONS": request.app.state.config.SHOW_ADMIN_INTEGRATIONS,
        "SHOW_ADMIN_WEB_SEARCH": request.app.state.config.SHOW_ADMIN_WEB_SEARCH,
        "SHOW_ADMIN_CODE_EXECUTION": request.app.state.config.SHOW_ADMIN_CODE_EXECUTION,
        "SHOW_ADMIN_INTERFACE": request.app.state.config.SHOW_ADMIN_INTERFACE,
        "SHOW_ADMIN_AUDIO": request.app.state.config.SHOW_ADMIN_AUDIO,
        "SHOW_ADMIN_IMAGES": request.app.state.config.SHOW_ADMIN_IMAGES,
        "SHOW_ADMIN_PIPELINES": request.app.state.config.SHOW_ADMIN_PIPELINES,
        "SHOW_ADMIN_DATABASE": request.app.state.config.SHOW_ADMIN_DATABASE,
        "ADMIN_EMAIL": request.app.state.config.ADMIN_EMAIL,
...
class AdminConfig(BaseModel):
    ...
    SHOW_ADMIN_EVALUATIONS: bool
    SHOW_ADMIN_INTEGRATIONS: bool
    SHOW_ADMIN_WEB_SEARCH: bool
    SHOW_ADMIN_CODE_EXECUTION: bool
    SHOW_ADMIN_INTERFACE: bool
    SHOW_ADMIN_AUDIO: bool
    SHOW_ADMIN_IMAGES: bool
    SHOW_ADMIN_PIPELINES: bool
    SHOW_ADMIN_DATABASE: bool
...
async def update_admin_config(
    ...
    request.app.state.config.SHOW_ADMIN_EVALUATIONS = form_data.SHOW_ADMIN_EVALUATIONS
    request.app.state.config.SHOW_ADMIN_INTEGRATIONS = form_data.SHOW_ADMIN_INTEGRATIONS
    request.app.state.config.SHOW_ADMIN_WEB_SEARCH = form_data.SHOW_ADMIN_WEB_SEARCH
    request.app.state.config.SHOW_ADMIN_CODE_EXECUTION = form_data.SHOW_ADMIN_CODE_EXECUTION
    request.app.state.config.SHOW_ADMIN_INTERFACE = form_data.SHOW_ADMIN_INTERFACE
    request.app.state.config.SHOW_ADMIN_AUDIO = form_data.SHOW_ADMIN_AUDIO
    request.app.state.config.SHOW_ADMIN_IMAGES = form_data.SHOW_ADMIN_IMAGES
    request.app.state.config.SHOW_ADMIN_PIPELINES = form_data.SHOW_ADMIN_PIPELINES
    request.app.state.config.SHOW_ADMIN_DATABASE = form_data.SHOW_ADMIN_DATABASE
